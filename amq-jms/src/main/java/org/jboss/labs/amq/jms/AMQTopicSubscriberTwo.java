...
public class AMQTopicSubscriberTwo implements MessageListener {

    public AMQTopicSubscriberTwo(){
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AMQTopicSubscriberTwo httpQueueConsumer = new AMQTopicSubscriberTwo();
            MessageConsumer messageConsumer = session.createDurableConsumer(topic, "InMotions");
